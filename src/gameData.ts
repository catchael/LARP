    ...
    pavilion: {
      ...
      evidences: [
        ...
        },
        {
          ...
          advancedDetails: '這是一條能承受極高拉力的專業露營用尼龍繩。是靠著一股蠻力將死者的手腳死死纏繞、勒緊，顯示兇手當時的情緒處於極度亢奮或慌亂中。',
          iconName: Cable,
    ...
    bushes_pit: {
      ...
      evidences: [
        ...
        },
        {
          ...
          advancedDetails: '這是一支無法追蹤來源的拋棄式老舊手機。有封模糊的簡訊螢幕已經完全碎裂，無法看清內容。',
          iconName: Smartphone,
    ...
    walkway_sink: {
      ...
      evidences: [
        ...
        },
        {
          ...
          name: '洗手台旁的草叢',
          brief: '塗層塑膠雨傘',
          details: '在洗手台後方的隱蔽草叢裡，丟著一把有塗層塑膠雨傘。',
          advancedDetails: '這是一把可防曬的塑膠雨傘。它被隨意地扔在洗手台後方的草叢裡，傘面是半開有些變形的狀態，顯然主人因為極度慌張而忘了帶走。',
          iconName: Umbrella,
